...
class FITDPLDigitWriter
{
  ...
  using MCCont = o2::dataformats::MCTruthContainer<o2::fv0::MCLabel>;

 public:
  void init(framework::InitContext& ic)
  {

    LOG(INFO) << "calling FV0 DigitWriterSpecs init (arvind)===================>";
  ...
  void run(framework::ProcessingContext& pc)
  {
    ...
    auto inDigits = pc.inputs().get<std::vector<o2::fv0::Digit>>((detStr + "digits").c_str());
 ...
 protected:
  ...
  std::vector<o2::fv0::Digit> mDigits; // input digits
  std::unique_ptr<TFile> mOutFile;
  std::unique_ptr<TTree> mOutTree;
};

//_______________________________________________
class FV0DPLDigitWriter : public FITDPLDigitWriter
{
 public:
...
constexpr o2::detectors::DetID::ID FV0DPLDigitWriter::DETID;
constexpr o2::header::DataOrigin FV0DPLDigitWriter::DETOR;

//_______________________________________________
/// create the processor spec
/// describing a processor receiving digits for FV0 and writing them to file
DataProcessorSpec getFV0DigitWriterSpec()
{
  std::string detStr = o2::detectors::DetID::getName(FV0DPLDigitWriter::DETID);
  std::string detStrL = detStr;
  std::transform(detStrL.begin(), detStrL.end(), detStrL.begin(), ::tolower);
  auto detOrig = FV0DPLDigitWriter::DETOR;
  ...
  return DataProcessorSpec{
    ...
    inputs,
    {}, // no output
    AlgorithmSpec(adaptFromTask<FV0DPLDigitWriter>()),
    Options{
