...
class Detector : public o2::base::DetImpl<Detector>
{
 ...
 private:
  ...
  static constexpr Float_t sEps = 0.025;

  // frame 1 has a longer side horizontal
  static constexpr Float_t sFrame1X = 21.500;
  static constexpr Float_t sFrame1Y = 13.705;
  static constexpr Float_t sFrame1PosX = 7.9278;
  static constexpr Float_t sFrame1PosY = 9.2454;
  ...
  static constexpr Float_t sFrame2PosX = 10.1428;
  static constexpr Float_t sFrame2PosY = -8.3446;
